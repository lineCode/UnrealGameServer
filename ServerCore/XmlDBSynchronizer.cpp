...
namespace StoredProcedures
{
	...
	public:
		...
		void Out_ObjectId(OUT int32& value) { BindCol(1,value); }
		template<int32 N> void Out_IndexName(OUT WCHAR(&value)[N]) { BindCol(2,value); }
		void Out_IndexId(OUT int32& value) { BindCol(3,value); }
		void Out_IndexType(OUT int32& value) { BindCol(4, value); }
		void Out_IsPrimaryKey(OUT bool& value) { BindCol(5,value); }
		void Out_IsUniqueConstraint(OUT bool& value) { BindCol(6,value); }
		void Out_ColumnId(OUT int32& value) { BindCol(7,value); }
		template<int32 N> void Out_ColumnName(OUT WCHAR(&value)[N]) { BindCol(8,value); }
	};
